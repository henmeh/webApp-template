...
class _SidebarState extends State<Sidebar> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          button(buttoncolors[0], Theme.of(context).highlightColor, "Button 3",
              _changeSide, [HomeRoute, 0]),
          SizedBox(height: 20),
          button(buttoncolors[1], Theme.of(context).highlightColor, "Button 4",
              _changeSide, [Button4Route, 1]),
          SizedBox(height: 20),
          button(buttoncolors[2], Theme.of(context).highlightColor, "Button 5",
              _changeSide, [Button5Route, 2]),
        ],
      ),
    );
  }
